...
/***/ function(module, exports, __webpack_require__) {
	...
	var _playlister = __webpack_require__(1);

	var _playlister2 = _interopRequireDefault(_playlister);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var PlaylisterConstants = _interopRequireWildcard(_constants);

	var _actions = __webpack_require__(179);

	var _stores = __webpack_require__(183);

	var _spotify = __webpack_require__(184);

	var _submitter = __webpack_require__(185);
	...
	*/
	  ...
	  _createClass(PlaylistContainer, [{
	    ...
	    value: function render() {
	      ...
	      if (playlist.length === 0) {
	        ...
	        var tracks = playlist.map(function (letter) {
	          return _react2.default.createElement(_spotify.Track, { key: letter, track: letter });
	        });
	        console.log(JSON.stringify(this.state.query));

	        var trackRows = [];
	        for (var i = 0; i < tracks.length; i += 3) {
	          trackRows.push(_react2.default.createElement(
	            'tr',
	            null,
	    ...
	    value: function getStores() {
	      ...
	      console.log("inside getStores, playlistResultStore == " + _stores.playlistResultStore);
	      return [_stores.playlistResultStore];
	    }
	  }, {
	    key: 'calculateState',
	    value: function calculateState() {
	      var playlistStoreState = _stores.playlistResultStore.getState();
	...
	_reactDom2.default.render(_react2.default.createElement(_submitter.PlayListSubmitter, null), document.getElementById('artistList'));

	_reactDom2.default.render(_react2.default.createElement(QueryContainer, null), document.getElementById('playlist'));
...
/***/ function(module, exports) {
	...
	var NEW_QUERY = exports.NEW_QUERY = 'new-query';
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.requestPlaylist = requestPlaylist;
	...
	function createNewQuery(artistArray) {
	    console.log("Create new query action triggered");
	    _dispatcher.PlaylistDispatcher.dispatch({
	        actionType: PlaylisterConstants.NEW_QUERY,
	        query: artistArray
	    });
	}

	function requestPlaylist(query) {

	    var xmlhttp = new XMLHttpRequest(),
	        method = 'GET',
	        url = 'http://localhost:9000/playlist?artistQuery=' + query;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var PlaylistResultStore = function (_ReduceStore) {
	  _inherits(PlaylistResultStore, _ReduceStore);

	  function PlaylistResultStore() {
	    _classCallCheck(this, PlaylistResultStore);

	    return _possibleConstructorReturn(this, Object.getPrototypeOf(PlaylistResultStore).apply(this, arguments));
	  }

	  _createClass(PlaylistResultStore, [{
	    key: 'getInitialState',
	    ...
	    key: 'reduce',
	    //initialised in the parent constructor
	...
	var playlistResultStore = new PlaylistResultStore(_dispatcher.PlaylistDispatcher);
	exports.playlistResultStore = playlistResultStore;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _textEntryBox = __webpack_require__(186);
	...
	var PlayListSubmitter = exports.PlayListSubmitter = function (_React$Component) {
	  _inherits(PlayListSubmitter, _React$Component);

	  function PlayListSubmitter(props) {
	    _classCallCheck(this, PlayListSubmitter);

	    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(PlayListSubmitter).call(this, props));
	  ...
	  _createClass(PlayListSubmitter, [{
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        'div',
	        { className: 'submitter', onSubmit: this.handleSubmit },
	        _react2.default.createElement(_textEntryBox.TextEntryBox, { placeholder: 'Artist', updateEntry: this.updateEntry, createEntry: this.createEntry, data: this.state.data }),
	        _react2.default.createElement(
	          'button',
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.TextEntryBox = exports.TextEntry = undefined;
	...
	var TextEntry = exports.TextEntry = function (_React$Component) {
	  ...
	  function TextEntry(props) {
	    ...
	    _this.keyHasBeenPressed = _this.keyHasBeenPressed.bind(_this);
	    _this.state = { index: props.index, text: props.initialValue };
	    return _this;
	  }
	...
	var TextEntryBox = exports.TextEntryBox = function (_React$Component3) {
